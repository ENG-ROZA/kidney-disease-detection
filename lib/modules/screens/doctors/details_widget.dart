          ...
          children: [
            ...
            Row(
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.pushNamed(context, UserReviewsScreen.routeName,
                        arguments: doctorId);
                  },
                  child: Text(
                    "Your Review",
                ...
                Row(
                  children: [
                    CircleAvatar(
                      radius: 20.0,
                      backgroundImage:
                          AssetImage(userData?.user?.profileImage?.url ?? ""),
                    ),
                    const SizedBox(
                      width: 10.0,
                    ),
